...
*********************************************************************/
// TODO: Define the interface to start and run the engine. Remove this pad/input
// crud
#pragma once
...
enum class Event : uint32_t {
  ...
  AppTerminating,           /**< The application is being terminated by the OS. Called
                               on iOS in applicationWillTerminate(). Called on Android
                               in onDestroy()*/
  AppLowmemory,             /**< The application is low on memory, free memory if
                               possible. Called on iOS in
                               applicationDidReceiveMemoryWarning(). Called on Android
                               in onLowMemory()*/
  AppWillenterbackground,   /**< The application is about to enter the
                               background. Called on iOS in
                               applicationWillResignActive(). Called on
                               Android in onPause() */
  AppDidenterbackground,    /**< The application did enter the background and
                               may not get CPU for some time. Called on iOS in
                               applicationDidEnterBackground(). Called on
                               Android in onPause() */
  AppWillenterforeground,   /**< The application is about to enter the
                               foreground. Called on iOS in
                               applicationWillEnterForeground(). Called on
                               Android in onResume() */
  AppDidenterforeground,    /**< The application is now interactive. Called on
...
public:
  ...
  // Called to allow work loads in the task graph to be setup up before the game
  // logic update
