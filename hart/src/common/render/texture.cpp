...
/*
    ...
    This isn't an awful format so we parse it directly for info then pass it on to bgfx.
...
static char FileIdentifier[16] = {
    (char)'«', (char)'K', (char)'T', (char)'X', (char)' ', (char)'1', (char)'1', (char)'»', (char)'\r', (char)'\n', (char)'\x1A', (char)'\n'
};
